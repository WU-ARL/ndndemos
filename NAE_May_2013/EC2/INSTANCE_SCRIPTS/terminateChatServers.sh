...
source /project/arl/NDN/jdd/.ec2_access_east_1 
 ./ec2Run.py -t --timeout 300 -r $REGION_US_E1 -n "robochat_server2"
echo "us-west-1"
source /project/arl/NDN/jdd/.ec2_access_west_1 
 ./ec2Run.py -t --timeout 300 -r $REGION_US_W1 -n "robochat_server1"
echo "us-west-2"
source /project/arl/NDN/jdd/.ec2_access_west_2 
 ./ec2Run.py -t --timeout 300 -r $REGION_US_W2 -n "robochat_server3"
