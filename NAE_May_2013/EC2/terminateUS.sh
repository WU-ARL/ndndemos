...
echo "us-east-1"
 ./ec2Run.py -t -r $REGION_US_E1
echo "us-west-1"
 ./ec2Run.py -t -r $REGION_US_W1
echo "us-west-2"
 ./ec2Run.py -t -r $REGION_US_W2
exit
echo "eu_w1 (Ireland)"
 ./ec2Run.py -t -r $REGION_EU_W1
echo "ap_se1 (Singapore)"
 ./ec2Run.py -t -r $REGION_AP_SE1
echo "ap_se2 (Sydney)"
 ./ec2Run.py -t -r $REGION_AP_SE2
echo "ap_ne (Tokyo)"
 ./ec2Run.py -t -r $REGION_AP_NE1
echo "sa_e1 (Sao Paolo)"
 ./ec2Run.py -t -r $REGION_SA_E1
